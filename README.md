...
I work on **AI evaluation integrity** — whether the automatic checks we use to score and train
models actually measure what they claim, or can be satisfied without doing the work.

### What I do

- **Auditing automatic graders** — reading reward functions to find where full reward can be
  earned without solving the task
- **Reward hacking and specification gaming** — the failure classes, catalogued from real code
  rather than from the literature
- **Benign red teaming** of LLM agents — indirect prompt injection, in sandboxes or authorised
  programs only
